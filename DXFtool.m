        ...
        function plot(dxf)
            ...
            for i = 1:dxf.ne
                ...
                switch dxf.entities(i).name
                    case 'POINT'
                         plot_point(dxf.entities(i).point,line_col);
                    case 'LINE'
                         plot_line(dxf.entities(i).line,line_col);
                    case 'LWPOLYLINE'
                         plot_poly(dxf.entities(i).poly,line_col,hatch_col,dxf.entities(i).closed);
                    case 'CIRCLE'
                         plot_circle(dxf.entities(i).circle,dxf.divisions,line_col);
                    case 'ARC'
                         plot_arc(dxf.entities(i).arc,dxf.divisions,line_col);
                    case 'ELLIPSE'
                         plot_ellipse(dxf.entities(i).ellipse,dxf.divisions,line_col,hatch_col,dxf.entities(i).closed);
                    case 'SPLINE'
                         plot_spline(dxf.entities(i).spline,line_col);
                end
